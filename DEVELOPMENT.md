...
If this is your first time using Encore, you will need to install the CLI that runs the local development environment. Use the appropriate command for your system:
...
```bash
git remote add encore encore://contractor-management-saas-m5hi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/contractor-management-saas-m5hi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/contractor-management-saas-m5hi/settings/integrations/github)
