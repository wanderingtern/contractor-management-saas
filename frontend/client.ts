...
export function Environment(name: string): BaseURL {
    return `https://${name}-contractor-management-saas-m5hi.encr.app`
}
...
/**
 * Client is an API client for the contractor-management-saas-m5hi Encore application.
 */
export class Client {
 ...
 */
import { create as api_customer_create_create } from "~backend/customer/create";
import { deleteCustomer as api_customer_delete_deleteCustomer } from "~backend/customer/delete";
import { get as api_customer_get_get } from "~backend/customer/get";
import { list as api_customer_list_list } from "~backend/customer/list";
import { update as api_customer_update_update } from "~backend/customer/update";
...
export namespace customer {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_customer_create_create>): Promise<ResponseType<typeof api_customer_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/customers`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_customer_create_create>
        }
         ...
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_customer_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/customers/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_customer_get_get>
        }

        /**
         * Retrieves all customers, ordered by creation date (latest first).
         */
        public async list(): Promise<ResponseType<typeof api_customer_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/customers`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_customer_list_list>
        }

        /**
         * Updates an existing customer.
         */
        public async update(params: RequestType<typeof api_customer_update_update>): Promise<ResponseType<typeof api_customer_update_update>> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "contractor-management-saas-m5hi-Generated-TS-Client (Encore/v1.52.5)";
        }
